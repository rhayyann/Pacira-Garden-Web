        ...
        <div className="faq-wrapper">
          <div className="column1">
            <div className="faq-item" onClick={() => toggleAnswer(0)}>
              <div className="question">Bagaimana cara merawat tanaman di dalam pot ? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(1)}>
              <div className="question">Apa jenis tanaman yang cocok untuk tumbuh di dalam ruangan dengan sedikit bercahaya? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(2)}>
              <div className="question">Bagaimana cara agar tidak terjadi kesalahan ketika merawat taman kering? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(3)}>
              <div className="question">Apakah tanaman dalam pot memerlukan pupuk? Jika iya seberapa sering <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(4)}>
              <div className="question">Bagaimana cara merawat tanaman selama liburan atau ketika saya pergi dari rumah untuk waktu yang lama? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(5)}>
              <div className="question">Apa yang harus dilakukan jika tanaman saya terlalu besar untuk potnya? <i class="fa-solid fa-plus"></i></div>
          ...
          <div className="column2">
            <div className="faq-item" onClick={() => toggleAnswer(6)}>
              <div className="question">Berapa budget yang harus saya keluarkan dalam merawat tanaman di rumah? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(7)}>
              <div className="question">Apa yang harus dilakukan jika daun tanaman saya menguning? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="question">Bagaimana cara menangani hama dan penyakit pada tanaman saya ? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(9)}>
              <div className="question">Apakah ada tanaman yang mudah dirawat bagi pemula? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="faq-item" onClick={() => toggleAnswer(10)}>
              <div className="question">Bagaimana cara mengetahui kapan waktu yang tepat untuk memindahkan tanaman ke pot lebih besar? <i class="fa-solid fa-plus"></i></div>
            ...
            <div className="question">Jelaskan cara agar tanaman saya tidak cepat mati? <i class="fa-solid fa-plus"></i> </div>
